        ...
        <div class="same-height-row">
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <h3>Special for CANHEAL</h3>
                    <p>Aplikasi ini di khususkan untuk informasi delivery makanan sehat di kawasan rumah sakit.</p>
                </div>
            </div>
...
<div class="box text-center" data-animate="fadeInUp">
    <div class="container">
        <div class="col-md-12">
            <h3 class="text-uppercase"> E-CANHEAL bekerja sama dengan Rumah Sakit. </h3>

            <p class="lead"> <a href="warung.php">Check our Store!</a>
            </p>
        </div>
    </div>
</div>
